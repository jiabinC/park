...
import com.abin.park_system.entity.*;
import com.abin.park_system.service.*;
...
////////////////////////////////////关于车位开始
	...
	public String getAllCar(@RequestParam("status") String status,Model model) {
	    if (status.equals("1")) {
	        List<Park> carList = parkService.findParkByCheckStatus("审核中");
	...
	public String editCar(@RequestParam("carId") String id, Model model){
	...
	public Map<String,String> delCar(@RequestParam("carId") String id){
		Map<String,String> map = new HashMap<String,String>();
		map.put("res", "1");
